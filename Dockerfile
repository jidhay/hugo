...
RUN wget -q https://github.com/gohugoio/hugo/releases/download/v${HUGO_VERSION}/hugo_${HUGO_VERSION}_checksums.txt \
&& wget -q https://github.com/gohugoio/hugo/releases/download/v${HUGO_VERSION}/hugo_${HUGO_VERSION}_Linux-64bit.tar.gz \
&& grep hugo_${HUGO_VERSION}_Linux-64bit.tar.gz hugo_${HUGO_VERSION}_checksums.txt | sha256sum -sc \
&& tar -zxf hugo_${HUGO_VERSION}_Linux-64bit.tar.gz hugo \
&& mv hugo /usr/bin \
&& rm -f hugo_${HUGO_VERSION}_checksums.txt hugo_${HUGO_VERSION}_Linux-64bit.tar.gz \
